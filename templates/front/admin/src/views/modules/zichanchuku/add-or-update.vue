    ...
    >
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="出库说明" prop="chukushuoming">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="出库说明"
                  v-model="ruleForm.chukushuoming" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.chukushuoming" label="出库说明" prop="chukushuoming">
                    <span>{{ruleForm.chukushuoming}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
      ...
      this.$http({
        ...
        if (data && data.code === 0) {
          ...
          this.$message.error(data.msg);
            ...
            this.$http({
              url: `option/bumenguanliyuan/yonghuming`,
              method: "get"
            }).then(({ data }) => {
              if (data && data.code === 0) {
    ...
    yonghumingChange () {
      this.$http({
        url: `follow/bumenguanliyuan/yonghuming?columnValue=`+ this.ruleForm.yonghuming,
        method: "get"
      }).then(({ data }) => {
        if (data && data.code === 0) {
              if(data.data.bumen){
