<template>
  <div class="addEdit-block">
    ...
    >
      <el-row >
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'" label="挑拨编号" prop="tiaobobianhao">
            <el-input v-model="ruleForm.tiaobobianhao" 
                placeholder="挑拨编号" readonly></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.tiaobobianhao" label="挑拨编号" prop="tiaobobianhao">
              <el-input v-model="ruleForm.tiaobobianhao" 
                placeholder="挑拨编号" readonly></el-input>
          </el-form-item>
        </div>
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="调拨数量" prop="diaoboshuliang">
          <el-input v-model="ruleForm.diaoboshuliang" 
              placeholder="调拨数量" clearable  :readonly="ro.diaoboshuliang"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="调拨数量" prop="diaoboshuliang">
              <el-input v-model="ruleForm.diaoboshuliang" 
                placeholder="调拨数量" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
            ...
            <el-col :span="24">
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.shenqingneirong" label="申请内容" prop="shenqingneirong">
                    <span>{{ruleForm.shenqingneirong}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
        ...
        for (var o in obj){
          if(o=='tiaobobianhao'){
            this.ruleForm.tiaobobianhao = obj[o];
	    this.ro.tiaobobianhao = true;
            continue;
          }
	    ...
	    this.ro.zichanshuliang = true;
          ...
          if(o=='diaoboshuliang'){
            this.ruleForm.diaoboshuliang = obj[o];
	    this.ro.diaoboshuliang = true;
            continue;
          }
          if(o=='shenqingriqi'){
