<template>
  <div class="addEdit-block">
    ...
    >
      <el-row >
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'" label="入库编号" prop="rukubianhao">
            <el-input v-model="ruleForm.rukubianhao" 
                placeholder="入库编号" readonly></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.rukubianhao" label="入库编号" prop="rukubianhao">
              <el-input v-model="ruleForm.rukubianhao" 
                placeholder="入库编号" readonly></el-input>
          </el-form-item>
        </div>
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="采购价钱" prop="caigoujiaqian">
          <el-input v-model="ruleForm.caigoujiaqian" 
              placeholder="采购价钱" clearable  :readonly="ro.caigoujiaqian"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="采购价钱" prop="caigoujiaqian">
              <el-input v-model="ruleForm.caigoujiaqian" 
                placeholder="采购价钱" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="采购金额" prop="caigoujine">
            <el-input v-model="caigoujine"
                placeholder="采购金额" readonly></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.caigoujine" label="采购金额" prop="caigoujine">
              <el-input v-model="ruleForm.caigoujine" 
                placeholder="采购金额" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="财务工号" prop="caiwugonghao">
          <el-input v-model="ruleForm.caiwugonghao" 
              placeholder="财务工号" clearable  :readonly="ro.caiwugonghao"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="财务工号" prop="caiwugonghao">
              <el-input v-model="ruleForm.caiwugonghao" 
                placeholder="财务工号" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="财务姓名" prop="caiwuxingming">
          <el-input v-model="ruleForm.caiwuxingming" 
              placeholder="财务姓名" clearable  :readonly="ro.caiwuxingming"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="财务姓名" prop="caiwuxingming">
              <el-input v-model="ruleForm.caiwuxingming" 
                placeholder="财务姓名" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      </el-row>
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="入库说明" prop="rukushuoming">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="入库说明"
                  v-model="ruleForm.rukushuoming" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.rukushuoming" label="入库说明" prop="rukushuoming">
                    <span>{{ruleForm.rukushuoming}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  data() {
	...
	caiwuxingming : false,
      ...
      rules: {
          ...
          caigoujiaqian: [
                { required: true, message: '采购价钱不能为空', trigger: 'blur' },
  ...
  computed: {
    caigoujine:{
      get: function () {
        return 1*this.ruleForm.caigoujiaqian*this.ruleForm.zichanshuliang
      }
    },
  },
  created() {
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.zichantupian = true;
          ...
          if(o=='caigoujiaqian'){
            this.ruleForm.caigoujiaqian = obj[o];
	    this.ro.caigoujiaqian = true;
            continue;
          }
          if(o=='zichanshuliang'){
	    ...
	    this.ro.zichanshuliang = true;
          ...
          if(o=='caigoujine'){
            this.ruleForm.caigoujine = obj[o];
	    this.ro.caigoujine = true;
            continue;
          }
          if(o=='rukuriqi'){
	    ...
	    this.ro.rukuriqi = true;
          ...
          if(o=='rukushuoming'){
            this.ruleForm.rukushuoming = obj[o];
	    this.ro.rukushuoming = true;
            continue;
          }
          if(o=='caiwugonghao'){
            this.ruleForm.caiwugonghao = obj[o];
	    this.ro.caiwugonghao = true;
            continue;
          }
          if(o=='caiwuxingming'){
            this.ruleForm.caiwuxingming = obj[o];
	    this.ro.caiwuxingming = true;
            continue;
          }
        }
      ...
      this.$http({
		...
		if(json.caiwugonghao!=''&&json.caiwugonghao){
                this.ruleForm.caiwugonghao = json.caiwugonghao
	    		this.ro.caiwugonghao = true;
		}
		if(json.caiwuxingming!=''&&json.caiwuxingming){
                this.ruleForm.caiwuxingming = json.caiwuxingming
	    		this.ro.caiwuxingming = true;
		}
        } else {
    ...
    // 提交
    onSubmit() {
        this.ruleForm.caigoujine = this.caigoujine
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `shengouruku/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.shengourukuCrossAddOrUpdateFlag = false;
						 this.parent.search();
