    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'" label="报废编号" prop="baofeibianhao">
            <el-input v-model="ruleForm.baofeibianhao" 
                placeholder="报废编号" readonly></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.baofeibianhao" label="报废编号" prop="baofeibianhao">
              <el-input v-model="ruleForm.baofeibianhao" 
                placeholder="报废编号" readonly></el-input>
          </el-form-item>
        </div>
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.baofeishuoming" label="报废说明" prop="baofeishuoming">
                    <span>{{ruleForm.baofeishuoming}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
